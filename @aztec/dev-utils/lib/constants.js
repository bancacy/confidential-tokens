...
var _require = require('./utils'),
    padLeft = _require.padLeft; // Pre-compute the commonly used values
...
var t2 = ["0x".concat(padLeft('1cf7cc93bfbf7b2c5f04a3bc9cb8b72bbcf2defcabdceb09860c493bdf1588d', 64)), "0x".concat(padLeft('8d554bf59102bbb961ba81107ec71785ef9ce6638e5332b6c1a58b87447d181', 64)), "0x".concat(padLeft('204e5d81d86c561f9344ad5f122a625f259996b065b80cbbe74a9ad97b6d7cc2', 64)), "0x".concat(padLeft('2cb2a424885c9e412b94c40905b359e3043275cd29f5b557f008cd0a3e0c0dc', 64))];
/**
...
var constants = {
   ...
   */
  CRS: ["0x".concat(padLeft(H_X.toString(16), 64)), "0x".concat(padLeft(H_Y.toString(16), 64))].concat(t2),
